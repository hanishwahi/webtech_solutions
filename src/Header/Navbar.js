      ...
      <div className="home-hero-section wf-section sticky-top bg-white border-bottom">
        <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease"
          ...
          <div className="nav-container">
            <Link  aria-current="page" className="nav-brand w-nav-brand w--current"><img onClick={scrollToHome} src={WebtechLogo2} loading="lazy" alt="" className="nav-logo-image" /></Link>
